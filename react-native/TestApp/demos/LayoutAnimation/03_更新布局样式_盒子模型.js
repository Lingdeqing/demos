    ...
    render() {
        ...
        return (
            <SafeAreaView>
                ...
                <View style={{ width: 100, height: 100, borderWidth: active ? 40 :10, borderColor: 'purple' }}></View>
                ...
                <View style={{ width: 100, height: 100, paddingLeft: active ? 50: 0, backgroundColor: 'purple' }}>
                    <View style={{height: 100, backgroundColor: 'black'}}></View>
                </View>

                {/* maxWidth */}
                <Text style={styles.title}>maxWidth</Text>
                <View style={{ width: 200, height: 100, maxWidth: active ? 100: 200, backgroundColor: 'purple' }}></View>
