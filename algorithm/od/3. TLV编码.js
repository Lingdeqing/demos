...
function solution(tag, source) {
    let tlv = source.split(' '), i = 0, t = '', l = '', v = ''
    while (i < tlv.length) {
        t = tlv[i++]
        l = parseInt(tlv[i + 1] + tlv[i], 16)
        i += 2
        if (t === tag) {
            return tlv.slice(i, i + l)
        } else {
            i += l
        }
    }
...
console.log(solution('31', '32 01 00 AE 90 02 00 01 02 30 03 00 AB 32 31 31 02 00 32 33 33 01 00 CC'))
